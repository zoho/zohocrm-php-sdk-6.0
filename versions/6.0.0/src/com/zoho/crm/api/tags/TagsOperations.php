...
class TagsOperations
{
	...
	public function getTags(ParameterMap $paramInstance=null)
	{
		...
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v6/settings/tags'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public function addTags(string $recordId, string $moduleAPIName, NewTagRequestWrapper $request, ParameterMap $paramInstance=null)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v6/'); 
	 ...
	 * @return APIResponse An instance of APIResponse
	 */
	public function removeTags(string $recordId, string $moduleAPIName, ExistingTagRequestWrapper $request)
	{
		$handlerInstance=new CommonAPIHandler(); 
		$apiPath=""; 
		$apiPath=$apiPath.('/crm/v6/'); 
